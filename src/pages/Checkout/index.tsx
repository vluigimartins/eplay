...
const Checkout = () => {
  const [payWidthCard, setPayWithCard] = useState(false)
            ...
            {payWidthCard ? (
              <>
                <Row>
                  ...
                  <InputGroup>
                    <label htmlFor="cpfcardOwner">CPF titular do cartão</label>
                    <input
                      type="text"
                      id="cpfcardOwner"
                      name="cpfCardOwer"
                ...
                <Row marginTop="24px">
                  <InputGroup maxWidth="150px">
                    ...
                    <small>
                      {getErrorMessage('isntallments', form.errors.fullName)}
                    </small>
                  </InputGroup>
                </Row>
              </>
